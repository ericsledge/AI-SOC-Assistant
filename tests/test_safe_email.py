"""Test the phishing analyzer using a safe email."""
...
def main() -> None:
    """Read and analyze the safe email sample."""

    project_root = Path(__file__).resolve().parent.parent
    email_path = project_root / "data" / "safe_email.txt"
    ...
    print("Analyzing safe test email...")
    ...
    try:
        ...
        print("=" * 60)
        print("SAFE EMAIL ANALYSIS RESULT")
        print("=" * 60)
        print(result)
        print("=" * 60)
